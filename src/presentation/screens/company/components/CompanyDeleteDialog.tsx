...
export function CompanyDeleteDialog({
  ...
  return (
    ...
    >
      <AlertDialogContent
        className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl"
        dir={dir}
      >
        <AlertDialogHeader>
          <AlertDialogTitle className="text-zinc-900 dark:text-zinc-50 text-sm text-left">
            {t("confirm_delete_title")}
          </AlertDialogTitle>
          <AlertDialogDescription className="text-zinc-500 dark:text-zinc-400 text-xs text-left">
            {t("delete_company_desc")}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
