...
interface BillListPaginationProps {
  page: number;
...
export function BillListPagination({
  page,
  setPage,
  perPage,
  setPerPage,
    ...
    <div
      className={cn(
        ...
        viewMode === "list"
          ...
          : "rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-955 shadow-xs"
      )}
    >
      <div className="flex items-center gap-2">
        ...
        >
          <SelectTrigger className="w-[80px] h-8 bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 text-xs">
        ...
        <span className="text-sm text-zinc-550 dark:text-zinc-400">
          {t("items_per_page", { defaultValue: "items per page" })} ({t("total")}: {total})
        </span>
      </div>
